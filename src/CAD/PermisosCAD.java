...
public class PermisosCAD extends ConexionDB {
    ...
    public ArrayList CargarPermisos(String Permiso){
        //Tabla Permisos
        ...
        try {
            ...
            while (rs.next()) {   
                String CodigoPermiso,NombrePermiso,Habilitado;
                int IdPermiso,IdRoll;
                IdPermiso = (rs.getInt(1));                
                CodigoPermiso = (rs.getString(2));                
                NombrePermiso = (rs.getString(3));
                IdRoll = (rs.getInt(4));
                Habilitado = (rs.getString(5));
                
            Permisos oPermiso = new Permisos(IdPermiso,CodigoPermiso,NombrePermiso,IdRoll,Habilitado);            
            Lista.add(oPermiso);
